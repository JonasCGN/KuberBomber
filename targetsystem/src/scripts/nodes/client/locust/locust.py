...
class MyUser(HttpUser):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.current_phase = "low"  # "low" ou "high"
        self.phase_elapsed_wall = 0.0    # tempo de parede na fase atual
    ...
    def _maybe_switch_phase(self):
        """Alterna a fase quando a duração configurada for atingida (por tempo de parede)."""
    ...
    def exponential_wait(self):
        """
        Gera tempo de espera a partir de uma exponencial com média definida.
        random.expovariate espera λ = 1/mean.
        """
        mean_time = self._current_mean_time()
